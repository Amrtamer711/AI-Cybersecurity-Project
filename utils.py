...
class KNN(nn.Module):
    def __init__(self, context_size, num_metadata_features=None, n_neighbors=5, algorithm='auto', metric='minkowski'):
        super().__init__()
        self.context_size = context_size
        self.num_metadata_features = num_metadata_features
        self.input_size = context_size + (num_metadata_features or 0)
